        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            <div className="space-y-8">
              ...
              {/* Introduction */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">1. What Are Cookies?</h2>
              ...
              {/* Types of Cookies */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">2. Types of Cookies We Use</h2>
              ...
              {/* Specific Cookies */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">3. Specific Cookies We Use</h2>
              ...
              {/* Third Party Cookies */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">4. Third-Party Cookies</h2>
                <p className="text-gray-300 leading-relaxed mb-4">
              ...
              {/* Cookie Consent */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">5. Your Cookie Choices</h2>
              ...
              {/* Mobile Apps */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">6. Mobile App Data</h2>
                <p className="text-gray-300 leading-relaxed mb-4">
              ...
              {/* Data Subject Rights */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">7. Your Rights</h2>
                <p className="text-gray-300 leading-relaxed mb-4">
              ...
              {/* International Users */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">8. International Users</h2>
                <p className="text-gray-300 leading-relaxed mb-4">
              ...
              {/* Updates */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">9. Updates to This Policy</h2>
                <p className="text-gray-300 leading-relaxed mb-4">
              ...
              {/* Contact */}
              <section>
                <h2 className="text-2xl font-bold mb-4 text-orange">10. Contact Us</h2>
