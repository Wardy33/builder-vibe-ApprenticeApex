        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300">See exactly what you'll pay based on your hiring needs</p>
            </div>
            ...
            <div className="bg-gray-900 p-8 rounded-xl border border-gray-700">
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div>
                  <label className="block text-white font-medium mb-2">Estimated Hires/Month</label>
                  <input
                    type="number"
                    value={estimatedHires}
                    onChange={(e) => setEstimatedHires(parseInt(e.target.value) || 0)}
                    className="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white"
                    min="0"
                    max="50"
                  />
              ...
              {calculatedCost && (
                <div className="bg-gray-800 p-6 rounded-lg border border-gray-600">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-bold text-white">Monthly Cost Estimate</h3>
                    <div className="text-3xl font-bold text-orange-400">
                      {formatCurrency(calculatedCost.estimatedMonthlyCost)}
                    </div>
                  </div>
                  
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <div className="text-gray-400 text-sm">Base Monthly Fee</div>
                      <div className="text-white font-semibold">
                        {formatCurrency(calculatedCost.breakdown.baseFee)}
                      </div>
                    </div>
                    <div>
                      <div className="text-gray-400 text-sm">Success Fees</div>
                      <div className="text-white font-semibold">
                        {formatCurrency(calculatedCost.breakdown.successFees)}
                      </div>
                    </div>
                  </div>
                </div>
