...
export default function JobDetail() {
  ...
  useEffect(() => {
    const fetchJob = async () => {
      try {
        setLoading(true);
        const response = await fetch(`/api/apprenticeships/public/${actualJobId}`);
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 mb-8">
                {error || "This job listing is no longer available or may have expired."}
              </p>
    ...
    <WebLayout>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "workHours": job.employmentType === "full-time" ? "40 hours per week" : "Part-time hours",
          "industry": job.industry,
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-gray-400">
              ...
              <li>/</li>
              <li><Link to="/search-jobs" className="hover:text-white transition-colors">Search Jobs</Link></li>
              <li>/</li>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-3 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-white">{job.applicationCount}</div>
                    <div className="text-sm text-gray-400">Applications</div>
                  </div>
                  <div className="text-center p-3 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-white">{job.viewCount}</div>
                    <div className="text-sm text-gray-400">Views</div>
                  </div>
                  <div className="text-center p-3 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-white">{job.duration.months}</div>
                    <div className="text-sm text-gray-400">Months</div>
                  </div>
                  <div className="text-center p-3 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-white">{job.daysUntilDeadline}</div>
                  ...
                  <div className="bg-orange-500/20 border border-orange-500 rounded-xl p-4 mb-6">
                    <div className="flex items-center gap-2 text-orange-300">
                      ...
                      <span className="font-medium">
                        Application closes in {job.daysUntilDeadline} day{job.daysUntilDeadline !== 1 ? 's' : ''}!
                      </span>
                    </div>
                  </div>
                )}
              ...
              {/* Job Description */}
              <div className="bg-gray-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                <h2 className="text-2xl font-bold text-white mb-6">About This Apprenticeship</h2>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">{job.requirements.experience}</p>
                  </div>
                </div>
                ...
                {job.requirements.certifications.length > 0 && (
                  <div className="mt-6">
                    <h3 className="text-lg font-semibold text-white mb-3">Preferred Certifications</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl p-6 text-white sticky top-8">
                ...
                <p className="text-white/90 mb-6">
                  Create your free account to apply for this apprenticeship and access exclusive opportunities.
                </p>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-white text-right">{formatDate(job.createdAt)}</span>
                  </div>
                  
                  <div className="flex justify-between items-start">
                    <span className="text-gray-400">Deadline:</span>
                    <span className="text-white text-right">{formatDate(job.applicationDeadline)}</span>
                  </div>
                  
                  <div className="flex justify-between items-start">
                    <span className="text-gray-400">Start Date:</span>
                    <span className="text-white text-right">{formatDate(job.duration.startDate)}</span>
                  </div>
                  
                  <div className="flex justify-between items-start">
                    <span className="text-gray-400">Duration:</span>
                    <span className="text-white text-right">{job.duration.months} months</span>
                  </div>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-white text-right">
                      ...
                      {job.isRemote && (
                        <div className="text-green-400 text-sm">Remote options available</div>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-white text-right">{job.industry}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-16 bg-gradient-to-br from-orange-400 via-pink-500 to-blue-500 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                Discover other exciting apprenticeship opportunities in {job.industry} and beyond.
              </p>
