        ...
        <div className="container mx-auto px-4 py-12 lg:py-16">
          ...
          <header className="text-center mb-16 relative">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-4 relative z-10">
              <span className="bg-gradient-to-r from-orange-400 via-pink-500 to-blue-500 bg-clip-text text-transparent animate-pulse">
                Apprentice
              </span>
              <span className="text-white drop-shadow-lg">Apex</span>
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              <div className="text-center">
                <div className="w-20 h-32 bg-gradient-to-br from-orange-400 to-pink-500 rounded-2xl mx-auto mb-4 p-4 transform rotate-12 hover:rotate-0 transition-all duration-300 shadow-2xl border border-white/20">
                  <div className="bg-white/90 rounded-xl h-full flex flex-col justify-center items-center text-xs">
                    <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full mb-2 animate-pulse"></div>
                    <div className="text-gray-800 font-bold">Software Dev</div>
                    <div className="text-gray-600">£20k</div>
                  </div>
                </div>
              ...
              {/* Step 2 */}
              <div className="text-center">
                <div className="w-20 h-32 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl mx-auto mb-4 p-4 transform -rotate-6 hover:rotate-0 transition-all duration-300 shadow-2xl border border-white/20">
                  <div className="bg-white/90 rounded-xl h-full flex flex-col justify-center items-center text-xs">
                    <div className="w-8 h-8 bg-gradient-to-br from-orange-400 to-pink-500 rounded-full mb-2 animate-bounce"></div>
                    <div className="text-gray-800 font-bold">✓ Match!</div>
                    <div className="text-green-600">92% fit</div>
                  </div>
                </div>
