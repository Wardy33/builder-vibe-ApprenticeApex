    ...
    <div className="p-4 space-y-6">
      ...
      <div>
        ...
        {mockApplications.length === 0 ? (
          <div className="bg-gradient-to-br from-blue-400/40 to-blue-600/50 border border-blue-400/60 rounded-xl backdrop-blur-sm p-8 text-center shadow-xl">
        ...
        <div className="space-y-2">
          {mockConversations.map((conversation) => (
            <div
              ...
              className="bg-gradient-to-br from-cyan-400/20 to-blue-500/20 backdrop-blur-sm border border-cyan-400/30 rounded-xl p-6 flex items-center space-x-4 cursor-pointer shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 group"
            >
              <img
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-gradient-to-br from-cyan-400/20 to-blue-500/20 border border-cyan-400/30 rounded-xl backdrop-blur-sm overflow-hidden shadow-xl">
          <img
        ...
        {/* Description */}
        <div className="bg-gradient-to-br from-cyan-400/20 to-blue-500/20 border border-cyan-400/30 rounded-xl backdrop-blur-sm p-8 shadow-xl">
    ...
    <div className="p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-gray-700">
          <button className="w-full bg-gradient-to-br from-cyan-400/20 to-blue-500/20 border border-cyan-400/30 text-white py-4 px-6 rounded-xl flex items-center justify-between backdrop-blur-sm shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
