    ...
    <div className="p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-gray-700">
          <button className="w-full bg-gradient-to-br from-blue-400/40 to-blue-600/50 border border-blue-400/60 text-white py-4 px-6 rounded-xl flex items-center justify-between backdrop-blur-sm shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
