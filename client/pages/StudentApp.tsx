      ...
      <div className="relative h-full">
        ...
        {showTransportModal && (
          <div className="absolute inset-0 bg-black/80 flex items-center justify-center p-4 z-20">
            <div className="bg-gradient-to-br from-cyan-300/60 via-blue-400/50 to-cyan-500/70 backdrop-blur-xl rounded-2xl p-6 w-full max-w-sm border border-cyan-300/60 shadow-2xl shadow-cyan-400/50">
        ...
        {mockApplications.length === 0 ? (
          ...
          <div className="space-y-3">
            {mockApplications.map((application) => (
              <div
                key={application.id}
                className="bg-[#00D4FF]/60 border border-[#00D4FF]/80 rounded-lg backdrop-blur-sm p-4 shadow-lg shadow-[#00D4FF]/40 hover:shadow-xl hover:shadow-[#00D4FF]/60 hover:scale-102 transition-all duration-300 hover:border-[#00D4FF] group cursor-pointer"
              >
      ...
      {mockMatches.length === 0 ? (
        ...
        <div className="space-y-4">
          {mockMatches.map((match) => (
            <div
              key={match.id}
              className="bg-gradient-to-br from-cyan-300/60 via-blue-400/50 to-cyan-500/70 border border-cyan-300/60 rounded-lg backdrop-blur-sm p-4 flex items-center space-x-4 shadow-lg shadow-cyan-400/40 hover:shadow-xl hover:shadow-blue-300/60 hover:scale-102 transition-all duration-300 hover:border-cyan-200/80 group cursor-pointer"
            >
              <img
                src={match.image}
                alt={match.jobTitle}
        ...
        <div className="space-y-2">
          {mockConversations.map((conversation) => (
            <div
              ...
              className="bg-gradient-to-br from-cyan-300/60 via-blue-400/50 to-cyan-500/70 backdrop-blur-sm border border-cyan-300/60 hover:from-cyan-200/70 hover:via-blue-300/60 hover:to-cyan-400/80 rounded-lg p-4 flex items-center space-x-4 cursor-pointer transition-all duration-300 shadow-lg shadow-cyan-400/40 hover:shadow-xl hover:shadow-blue-300/60 hover:scale-102 hover:border-cyan-200/80 group"
            >
              <img
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-gradient-to-br from-cyan-300/60 via-blue-400/50 to-cyan-500/70 border border-cyan-300/60 rounded-lg backdrop-blur-sm overflow-hidden shadow-lg shadow-cyan-400/40">
          <img
        ...
        {/* Description */}
        <div className="bg-gradient-to-br from-cyan-300/60 via-blue-400/50 to-cyan-500/70 border border-cyan-300/60 rounded-lg backdrop-blur-sm p-6 shadow-lg shadow-cyan-400/40">
