      ...
      <div className="relative h-full">
        ...
        {showTransportModal && (
          <div className="absolute inset-0 bg-black/80 flex items-center justify-center p-4 z-20">
            <div className="bg-gradient-to-br from-purple-500/40 to-pink-500/50 backdrop-blur-xl rounded-2xl p-8 w-full max-w-sm border border-purple-400/50 shadow-2xl">
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-pink-400/40 to-pink-600/50 border border-pink-400/50 rounded-xl backdrop-blur-sm p-6 text-center shadow-xl hover:shadow-pink-500/30 transition-all duration-300 hover:scale-105">
      ...
      <div>
        ...
        {mockApplications.length === 0 ? (
          <div className="bg-gradient-to-br from-pink-400/40 to-pink-600/50 border border-pink-400/50 rounded-xl backdrop-blur-sm p-8 text-center shadow-xl">
            ...
            <Link
              to="/student/jobs"
              className="bg-white text-purple-600 hover:bg-gray-50 px-6 py-3 rounded-lg text-sm font-semibold transition-all duration-300 hover:scale-105 shadow-xl border border-purple-200"
            >
              Find Jobs
            </Link>
          </div>
          ...
          <div className="space-y-3">
            {mockApplications.map((application) => (
              <div
                key={application.id}
                className="bg-gradient-to-br from-pink-400/40 to-pink-600/50 border border-pink-400/50 rounded-xl backdrop-blur-sm p-6 shadow-xl hover:shadow-pink-500/30 hover:scale-105 transition-all duration-300 cursor-pointer group"
              >
        ...
        {mockInterviews.length === 0 ? (
          ...
          <div className="space-y-3">
            {mockInterviews.map((interview) => (
              <div
                key={interview.id}
                className="bg-gradient-to-br from-purple-500/40 to-pink-500/50 border border-purple-400/50 rounded-xl backdrop-blur-sm p-6 shadow-xl hover:shadow-purple-500/30 hover:scale-105 transition-all duration-300 cursor-pointer group"
              >
                <div className="flex items-center space-x-4">
                  <img
                    src={interview.image}
    ...
    <div className="p-4">
      ...
      {mockMatches.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Link
            to="/student/jobs"
            className="bg-white text-purple-600 hover:bg-gray-50 px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-xl border border-purple-200"
          >
            Start Swiping
          </Link>
        </div>
        ...
        <div className="space-y-4">
          {mockMatches.map((match) => (
            <div
              key={match.id}
              className="bg-gradient-to-br from-purple-500/40 to-pink-500/50 border border-purple-400/50 rounded-xl backdrop-blur-sm p-6 flex items-center space-x-4 shadow-xl hover:shadow-purple-500/30 hover:scale-105 transition-all duration-300 cursor-pointer group"
            >
              <img
                src={match.image}
                alt={match.jobTitle}
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="bg-white text-purple-600 hover:bg-gray-50 px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 hover:scale-105 flex items-center justify-center gap-1 shadow-lg border border-purple-200"
                >
        ...
        <div className="space-y-2">
          {mockConversations.map((conversation) => (
            <div
              ...
              className="bg-gradient-to-br from-purple-500/40 to-pink-500/50 backdrop-blur-sm border border-purple-400/50 rounded-xl p-6 flex items-center space-x-4 cursor-pointer shadow-xl hover:shadow-purple-500/30 hover:scale-105 transition-all duration-300 group"
            >
              <img
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-gradient-to-br from-purple-500/40 to-pink-500/50 border border-purple-400/50 rounded-xl backdrop-blur-sm overflow-hidden shadow-xl">
          <img
        ...
        <div className="bg-gradient-to-br from-purple-500/40 to-pink-500/50 border border-purple-400/50 rounded-xl backdrop-blur-sm p-8 shadow-xl">
          <div className="text-center">
            ...
            <button className="w-full bg-gradient-to-r from-green-400 to-emerald-500 hover:from-green-500 hover:to-emerald-600 text-white py-4 px-6 rounded-xl font-bold transition-all duration-300 hover:scale-105 shadow-2xl border border-green-300">
              Apply Now
            </button>
          </div>
        </div>
    ...
    <div className="p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-gray-700">
          <button className="w-full bg-gradient-to-br from-purple-500/40 to-pink-500/50 border border-purple-400/50 text-white py-4 px-6 rounded-xl flex items-center justify-between backdrop-blur-sm shadow-xl hover:shadow-purple-500/30 hover:scale-105 transition-all duration-300">
