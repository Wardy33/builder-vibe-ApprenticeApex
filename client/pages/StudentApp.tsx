      ...
      {mockMatches.length === 0 ? (
        ...
        <div className="space-y-4">
          {mockMatches.map((match) => (
            <div
              key={match.id}
              className="bg-[#84CC16]/60 border border-[#84CC16]/80 rounded-lg backdrop-blur-sm p-4 flex items-center space-x-4 shadow-lg shadow-[#84CC16]/40 cursor-pointer"
            >
              <img
                src={match.image}
                alt={match.jobTitle}
        ...
        <div className="space-y-2">
          {mockConversations.map((conversation) => (
            <div
              ...
              className="bg-[#EF4444]/60 backdrop-blur-sm border border-[#EF4444]/80 rounded-lg p-4 flex items-center space-x-4 cursor-pointer shadow-lg shadow-[#EF4444]/40"
            >
              <img
