        ...
        {mockInterviews.length === 0 ? (
          ...
          <div className="space-y-3">
            {mockInterviews.map((interview) => (
              <div
                key={interview.id}
                className="bg-[#84CC16]/60 border border-[#84CC16]/80 rounded-lg backdrop-blur-sm p-4 shadow-lg shadow-[#84CC16]/40 hover:shadow-xl hover:shadow-[#84CC16]/60 hover:scale-102 transition-all duration-300 hover:border-[#84CC16] group cursor-pointer"
              >
                <div className="flex items-center space-x-4">
                  <img
                    src={interview.image}
      ...
      {mockMatches.length === 0 ? (
        ...
        <div className="space-y-4">
          {mockMatches.map((match) => (
            <div
              key={match.id}
              className="bg-[#84CC16]/60 border border-[#84CC16]/80 rounded-lg backdrop-blur-sm p-4 flex items-center space-x-4 shadow-lg shadow-[#84CC16]/40 hover:shadow-xl hover:shadow-[#84CC16]/60 hover:scale-102 transition-all duration-300 hover:border-[#84CC16] group cursor-pointer"
            >
              <img
                src={match.image}
                alt={match.jobTitle}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-[#84CC16]/60 border border-[#84CC16]/80 rounded-lg backdrop-blur-sm overflow-hidden shadow-lg shadow-[#84CC16]/40">
          <img
        ...
        {/* Description */}
        <div className="bg-[#84CC16]/60 border border-[#84CC16]/80 rounded-lg backdrop-blur-sm p-6 shadow-lg shadow-[#84CC16]/40">
    ...
    <div className="p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-gray-700">
          <button className="w-full bg-[#EF4444]/60 border border-[#EF4444]/80 hover:bg-[#EF4444]/70 text-white py-3 px-4 rounded-lg flex items-center justify-between transition-all duration-200 backdrop-blur-sm hover:scale-102 shadow-lg shadow-[#EF4444]/40 hover:shadow-[#EF4444]/60">
