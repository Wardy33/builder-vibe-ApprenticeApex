        ...
        <div className="space-y-2">
          {mockConversations.map((conversation) => (
            <div
              ...
              className="bg-gradient-to-br from-pink-400/40 to-pink-600/50 backdrop-blur-sm border border-pink-400/50 rounded-xl p-6 flex items-center space-x-4 cursor-pointer shadow-xl hover:shadow-pink-500/30 hover:scale-105 transition-all duration-300 group"
            >
              <img
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-gradient-to-br from-pink-400/40 to-pink-600/50 border border-pink-400/50 rounded-xl backdrop-blur-sm overflow-hidden shadow-xl">
          <img
        ...
        {/* Description */}
        <div className="bg-gradient-to-br from-pink-400/40 to-pink-600/50 border border-pink-400/50 rounded-xl backdrop-blur-sm p-8 shadow-xl">
