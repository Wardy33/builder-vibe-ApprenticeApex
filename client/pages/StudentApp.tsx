      ...
      <div className="relative h-full">
        ...
        {showTransportModal && (
          <div className="absolute inset-0 bg-black/80 flex items-center justify-center p-4 z-20">
            <div className="bg-[#00D4FF]/60 backdrop-blur-xl rounded-2xl p-6 w-full max-w-sm border border-[#00D4FF]/80 shadow-2xl shadow-[#00D4FF]/50">
        ...
        {mockApplications.length === 0 ? (
          ...
          <div className="space-y-3">
            {mockApplications.map((application) => (
              <div
                key={application.id}
                className="bg-[#EF4444]/60 border border-[#EF4444]/80 rounded-lg backdrop-blur-sm p-4 shadow-lg shadow-[#EF4444]/40 hover:shadow-xl hover:shadow-[#EF4444]/60 hover:scale-102 transition-all duration-300 hover:border-[#EF4444] group cursor-pointer"
              >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-[#00D4FF]/60 border border-[#00D4FF]/80 rounded-lg backdrop-blur-sm overflow-hidden shadow-lg shadow-[#00D4FF]/40">
          <img
        ...
        {/* Description */}
        <div className="bg-[#00D4FF]/60 border border-[#00D4FF]/80 rounded-lg backdrop-blur-sm p-6 shadow-lg shadow-[#00D4FF]/40">
    ...
    <div className="p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-gray-700">
          <button className="w-full bg-[#00D4FF]/60 border border-[#00D4FF]/80 hover:bg-[#00D4FF]/70 text-white py-3 px-4 rounded-lg flex items-center justify-between transition-all duration-200 backdrop-blur-sm hover:scale-102 shadow-lg shadow-[#00D4FF]/40 hover:shadow-[#00D4FF]/60">
