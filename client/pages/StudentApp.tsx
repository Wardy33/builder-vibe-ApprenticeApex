  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm p-4 text-center shadow-lg shadow-cyan-500/20">
      ...
      <div>
        ...
        {mockApplications.length === 0 ? (
          <div className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm p-6 text-center shadow-lg shadow-cyan-500/20">
          ...
          <div className="space-y-3">
            {mockApplications.map((application) => (
              <div
                key={application.id}
                className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm p-4 shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-400/40 hover:scale-105 transition-all duration-300 hover:border-cyan-300/50 group cursor-pointer"
              >
      ...
      {mockMatches.length === 0 ? (
        ...
        <div className="space-y-4">
          {mockMatches.map((match) => (
            <div
              key={match.id}
              className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm p-4 flex items-center space-x-4 shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-400/40 hover:scale-105 transition-all duration-300 hover:border-cyan-300/50 group cursor-pointer"
            >
              <img
                src={match.image}
                alt={match.jobTitle}
        ...
        <div className="space-y-2">
          {mockConversations.map((conversation) => (
            <div
              ...
              className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 backdrop-blur-sm border border-cyan-400/30 hover:from-blue-700/50 hover:via-cyan-600/50 hover:to-blue-800/40 rounded-lg p-4 flex items-center space-x-4 cursor-pointer transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-400/40 hover:scale-105 hover:border-cyan-300/50 group"
            >
              <img
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* Company Image */}
        <div className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm overflow-hidden shadow-lg shadow-cyan-500/20">
          <img
        ...
        {/* Description */}
        <div className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm p-6 shadow-lg shadow-cyan-500/20">
  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {/* Bio */}
          <div className="bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 rounded-lg backdrop-blur-sm p-4 shadow-lg shadow-cyan-500/20">
        ...
        <div className="pt-4 border-t border-gray-700">
          <button className="w-full bg-gradient-to-br from-blue-800/40 via-cyan-700/40 to-blue-900/40 border border-cyan-400/30 hover:from-blue-700/40 hover:via-cyan-600/40 hover:to-blue-800/40 text-white py-3 px-4 rounded-lg flex items-center justify-between transition-all duration-200 backdrop-blur-sm hover:scale-105 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-400/40">
