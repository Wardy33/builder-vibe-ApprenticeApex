      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            Create an account to unlock AI-powered matching and personalized recommendations.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-gray-400 text-sm">Sign up to see all 2,500+ opportunities</span>
          </div>
          ...
          {[
            ...
            },
            {
              ...
              duration: "24 months",
              type: "Full-time",
              description: "Learn the fundamentals of digital marketing including SEO, social media..."
            },
            {
              ...
              duration: "30 months",
              type: "Full-time",
              description: "Develop skills in data analysis, visualization, and business intelligence..."
            }
          ].map((job, index) => (
            <div key={index} className="bg-gray-900/50 rounded-xl p-6 border border-gray-800 hover:border-orange/30 transition-colors">
        ...
        <div className="text-center mt-12 pt-8 border-t border-gray-800">
          <p className="text-gray-300 mb-6">
            Ready to find your perfect apprenticeship match? Join thousands of students 
