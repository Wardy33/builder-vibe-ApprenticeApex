...
export default function LiveChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 bg-white rounded-lg shadow-2xl border border-gray-200 w-96 h-[500px] flex flex-col z-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-400 via-orange-500 to-red-500 text-white p-4 rounded-t-lg flex items-center justify-between">
          ...
          >
            <div className={`flex items-start space-x-2 max-w-[80%] ${message.sender === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                message.sender === 'user' ? 'bg-gradient-to-br from-orange-400 to-red-500' : 'bg-gradient-to-br from-orange-300 to-orange-500'
              }`}>
                {message.sender === 'user' ? (
        ...
        {isTyping && (
          <div className="flex justify-start">
            <div className="flex items-start space-x-2">
              <div className="w-6 h-6 bg-gradient-to-br from-orange-300 to-orange-500 rounded-full flex items-center justify-center">
                <Sparkles className="w-4 h-4 text-white animate-pulse" />
              </div>
              <div className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
                <div className="flex space-x-1">
                  <div className="w-2 h-2 bg-gradient-to-r from-orange-300 to-orange-400 rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                  <div className="w-2 h-2 bg-gradient-to-r from-orange-400 to-orange-500 rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                  <div className="w-2 h-2 bg-gradient-to-r from-orange-500 to-red-500 rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="bg-gradient-to-br from-orange-400 via-orange-500 to-red-500 hover:from-orange-500 hover:to-red-600 disabled:bg-gray-300 text-white p-2 rounded-lg transition-all duration-200 hover:scale-105"
          >
        ...
        <button
          ...
          className="w-full mt-2 text-transparent bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text hover:from-orange-500 hover:to-red-600 text-sm transition-all duration-200 font-medium"
        >
